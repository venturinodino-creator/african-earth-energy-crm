...
function renderContactFinder() {
  ...
  /* Accept all is always on the bar, greyed when there is nothing to
     ...
     One press ingests every pending find in the current filter into
     its municipality or company. A missing email is flagged on the
     row, not held against it — the reviewer can add one later on the
     contact itself. */
